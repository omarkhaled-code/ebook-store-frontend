...
const navLinks = [
  ...
  { label: 'Library',   href: '/dashboard/purchases', icon: 'book_2' },
...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 md:hidden bg-surface-container-low border-t border-outline-variant/30 flex items-center justify-around px-sm py-xs safe-area-pb">
      {navLinks.map((link) => {
